 ...
 */
namespace AHT\CategorySub\Block\Category;
...
class View extends \Magento\Framework\View\Element\Template implements \Magento\Framework\DataObject\IdentityInterface
{
    ...
    /**
     * Return identifiers for catagories sub
     *
     * @return array
     */
    public function getCategorySub($subcatid)
    {

        // $objectManager = \Magento\Framework\App\ObjectManager::getInstance();
        $_category =  $this->category->load($subcatid);
        return $_category;
    }
}
